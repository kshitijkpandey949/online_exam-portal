...
scale= showall>
    ...
    <td width="10%">
     <img border="0" src="image/ksv.jpg" width="23%" height="23%" align="left"></td>
     <img border="0" src="image/vsitr.png" width="70%" height="60%" align="right"></td>
  </tr>
</table>
<!--<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="image/blackbar.jpg">
  ...
  ?>
	...
	{
	 echo "<br><div align=\"right\"><strong><a href=\"index.php\"> Home </a>|<a href=\"signout.php\">Signout</a></strong></div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
