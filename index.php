...
echo "<h1 class='text-center bg-danger'>Welcome to Online Exam</h1>";
  ...
  <tr><br>
    <td width="10%" height="10%" valign="bottom"><img src="image/o.jpg" width="50" height="50" align="middle"></td>
    <td width="90%" valign="bottom" bordercolor="#0000FF"> <a href="sublist.php" class="style4"><h4><b>Subject for Quiz </b></h4></a></td>
  </tr>
  <tr>
    <td height="58" valign="bottom"><img src="image/d.jpg" width="50" height="50" align="absmiddle"></td>
    <td valign="bottom"> <a href="result.php" class="style4"><h4><b>Result </b></h4></a></td>
  </tr>
</table>';
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
      ...
      <span class="style5"><img src="image/h.jpg" width="50%" height="50%" align="center"><span class="style7"></span>        </span>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
		...
		<center>
		<img class="img-circle" src="l.jpg"  title="this is my profile pic" width="240px" height="190px" border="1" />
		</center>	<br>
      ...
      <div align="center">
        <p class="style5"><img src="images/tuk.png" width="134" height="128">          </p>
        </div>
    </form></td>
  </tr>
</table>
<blockquote>
          <u><p style="color:black;font-size:20px;">MADE BY: 
          </p></u>
      </blockquote>
<blockquote>
          <p style="color:black;font-size:20px;">KSHITIJ KUMAR PANDEY
