...
echo "<table width=150%> <tr> <td width=100 &nbsp;<td> <table border=0>";

$n=$_SESSION[qn]+1;

echo "<tr><td span class=style8>Que ".  $n .": $row[2]";
echo "<h1><tr><td class=style4><input type=radio name=ans value=1>$row[3]</h1>";
