...
?>
 <table width="100%" border="0">
   <tr>
     <td width="132" rowspan="2" valign="top"><span class="style8"><img src="images/rr.png" width="131" height="155"></span></td>
     <h1 class="text-center bg-primary"><i>REGISTERATION PAGE</i></h1>
   </tr>
   <tr>
